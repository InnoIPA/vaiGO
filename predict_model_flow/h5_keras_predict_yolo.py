...
class YOLO(object):
    _defaults = {
        "model_path"        : '../model2xmodel_package/testflow/ep608-loss2.911-val_loss2.554.h5',
        "anchors_path"      : 'core/yolo_anchors.txt',
        "classes_path"      : 'core/classes.txt',
        "score"             : 0.5,
        "iou"               : 0.45,
        "eager"             : False,
        "max_boxes"         : 100,
        ...
        "output_path"       : 'predict_flow_output'
    }
    ...
    def detect_image(self, image):
        ...
        image.save(os.path.join(self.output_path, "h5-predicted_class-{}.png".format(time.time())))
        end = timer()
        print(end - start)
